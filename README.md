...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "throbbing-block-dc29-d1":

```bash
npx wrangler d1 create throbbing-block-dc29-d1
```
